...
const char* mqttTopicSnap = "JasonEdington/feeds/pictures";
const char* mqttTopicStream = "JasonEdington/feeds/pictures2";
...
if(digitalRead(12) == 0){
  ...
  delay(PUBLISH_DELAY);
    ...
    analogWrite(13,0);
    analogWrite(15,0);
  }  // use a delay here - time since last attempt ended, not started
}
